...
@interface _TtC14T1TwitterSwift32T1StatusInlineTooltipViewAdapter : TFNComposableViewAdapter
{
    MISSING_TYPE *anchorFocusViewLayoutState;
}

- (void).cxx_destruct;
- (void)layoutAnchorFocusPoint;
