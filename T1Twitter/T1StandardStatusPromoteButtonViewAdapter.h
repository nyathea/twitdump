...
@interface T1StandardStatusPromoteButtonViewAdapter : TFNComposableViewAdapter
{
}

+ (id)promoteButtonScribeElementForViewModel:(id)arg1;
+ (id)promoteButtonTitleForViewModel:(id)arg1;
