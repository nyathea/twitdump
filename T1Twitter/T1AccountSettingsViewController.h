...
@interface T1AccountSettingsViewController : TFNItemsDataViewController
{
    ...
    MISSING_TYPE *verificationRequestWebViewDelegateHandler;
    MISSING_TYPE *$__lazy_storage_$_changePasswordItem;
    MISSING_TYPE *$__lazy_storage_$_securityItem;
    MISSING_TYPE *$__lazy_storage_$_twitterDataItem;
    MISSING_TYPE *$__lazy_storage_$_connectedAppsItem;
}
