...
+ (_Bool)isEligibleForEditWithGrok:(id)arg1 isFocal:(_Bool)arg2;
+ (id)editWithGrokButtonScribeElementForViewModel:(id)arg1;
+ (id)editWithGrokButtonTitleForViewModel:(id)arg1;
@property(nonatomic) _Bool isFocal; // @synthesize isFocal=_isFocal;
- (void)didTapEditWithGrokButtonView:(id)arg1;
