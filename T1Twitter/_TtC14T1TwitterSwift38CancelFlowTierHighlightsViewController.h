...
@interface _TtC14T1TwitterSwift38CancelFlowTierHighlightsViewController : TFNViewController
{
    MISSING_TYPE *account;
    MISSING_TYPE *premiumBasicHighlights;
    MISSING_TYPE *premiumHighlights;
    MISSING_TYPE *premiumPlusHighlights;
    ...
    MISSING_TYPE *cancelFlowDowngradeViewModel;
}
