...
@interface T1LiveEventHeaderView
{
    _Bool _previewing;
    _Bool _contentEmpty;
    ...
    _Bool _showMoreActionsButtonEnabled;
...
@property(readonly, nonatomic, getter=isShowMoreActionsButtonEnabled) _Bool showMoreActionsButtonEnabled; // @synthesize showMoreActionsButtonEnabled=_showMoreActionsButtonEnabled;
...
- (void)updateBarButtonsForLiveEventGeneratedByCurrentAccount:(_Bool)arg1 isUserGenerated:(_Bool)arg2;
...
- (id)initWithFrame:(struct CGRect)arg1 useCustomNavigationBar:(_Bool)arg2 isHeaderLockingEnabled:(_Bool)arg3 isHeaderSubtitleBlue:(_Bool)arg4 isHeaderSubtitleTapToExpandShown:(_Bool)arg5 isShowMoreActionsButtonEnabled:(_Bool)arg6;
