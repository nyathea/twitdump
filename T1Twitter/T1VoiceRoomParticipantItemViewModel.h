...
@class MISSING_TYPE, NSDictionary, NSString, TFSPCFLabel, TFSTwitterEntityMedia, TFSTwitterRelationship, TFSTwitterUserReference, TFSURTRichText, TUITwitterUserContext, _TtC14TFSTwitterCore25TFSTwitterPromotedContent;
@protocol T1TwitterSocialContext, TFSTwitterCanonicalUser;

@interface T1VoiceRoomParticipantItemViewModel : NSObject
{
    MISSING_TYPE *timelineModuleItemIndex;
    MISSING_TYPE *spaceUser;
    ...
    MISSING_TYPE *$__lazy_storage_$_promotedContent;
}
