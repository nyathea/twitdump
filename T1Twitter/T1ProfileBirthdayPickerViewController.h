...
@interface T1ProfileBirthdayPickerViewController : TFNItemsDataViewController
{
    ...
    TFNDataViewItem *_subtitlePolicyItem;
...
@property(retain, nonatomic) TFNDataViewItem *subtitlePolicyItem; // @synthesize subtitlePolicyItem=_subtitlePolicyItem;
...
- (void)profileBirthdayDisplayFormViewControllerSizeDidChange:(id)arg1;
