...
@interface T1StatusInlinePromptViewAdapter : TFNComposableViewAdapter
{
}

- (void)inlinePromptView:(id)arg1 didTapActionButton:(id)arg2;
- (id)_t1_statusInlinePromptViewModelForStatusViewModel:(id)arg1;
...
- (void)accessibilityPerformTapActionButtonOnInlinePromptView:(id)arg1;
