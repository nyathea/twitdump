...
@class NSDate, NSError, NSString, NSURL, TFNTwitterAccount, TFNTwitterMediaImagePipeline, TFSPendingStateToken, TTMAssetImage, UIImage;
...
@interface T1ProfileImageUploadOperation : TFSDependentConcurrentOperation
{
    ...
    TTMAssetImage *_uploadImageAsset;
...
@property(readonly, nonatomic) TTMAssetImage *uploadImageAsset; // @synthesize uploadImageAsset=_uploadImageAsset;
...
- (void)_t1_requestForcedUserRefreshAndCompleteOperation;
