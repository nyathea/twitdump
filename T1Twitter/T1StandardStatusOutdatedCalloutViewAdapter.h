...
@interface T1StandardStatusOutdatedCalloutViewAdapter : TFNComposableViewAdapter
{
    unsigned long long _displayType;
}

@property(readonly, nonatomic) unsigned long long displayType; // @synthesize displayType=_displayType;
- (void)outdatedCalloutView:(id)arg1 didTapRange:(id)arg2 rect:(struct CGRect)arg3;
