...
@class NSLayoutConstraint, NSString, NSTimer, T1VoiceTrackViewModel, TAVPlaybackState, TFNBarProgressView, TFNButton, TFNInformationToast, TUIAvatarImageView, UIAccessibilityCustomAction, UIButton, UIImage, UILabel, UIPanGestureRecognizer, UIStackView, UIView;
@protocol T1VoiceDockStatusContentViewDelegate, TUIVoiceDockContainer;

@interface T1VoiceDockStatusContentView
{
...
@property(nonatomic) __weak TFNInformationToast *playbackErrorToast; // @synthesize playbackErrorToast=_playbackErrorToast;
...
@property(retain, nonatomic) TUIAvatarImageView *imageView; // @synthesize imageView=_imageView;
