...
@class MISSING_TYPE, NSArray, NSDate, NSNumber, NSString, TFSPCFLabel, TFSTwitterEntityMedia, TFSTwitterEntitySet, TFSTwitterPlace, TFSTwitterProfessional, TFSTwitterRelationship, TFSTwitterTipJar, TFSTwitterUserDesignatorInfo, TFSTwitterUserExtendedProfile, TFSTwitterUserReference, TFSURTRichText;

@interface T1StandardSpaceCanonicalUserPlaceholder : NSObject
{
    MISSING_TYPE *userID;
    MISSING_TYPE *userIDNumber;
    ...
    MISSING_TYPE *hasBannerImageURL;
    MISSING_TYPE *numberOfFollowing;
    MISSING_TYPE *numberOfFollowers;
    MISSING_TYPE *hasExtendedProfileBirthday;
}
...
@property(nonatomic) _Bool hasExtendedProfileBirthday; // @synthesize hasExtendedProfileBirthday;
...
@property(nonatomic) long long numberOfFollowing; // @synthesize numberOfFollowing;
@property(nonatomic) _Bool hasBannerImageURL; // @synthesize hasBannerImageURL;
...
- (id)initWithGuestRoomUser:(id)arg1;
...
@property(nonatomic, retain) TFSTwitterEntityMedia *profileImageMediaEntity; // @synthesize profileImageMediaEntity;
@property(nonatomic, retain) TFSTwitterUserReference *userReference; // @synthesize userReference;
@property(nonatomic, copy) NSString *fullName;
@property(nonatomic, copy) NSString *username;
@property(nonatomic, retain) NSNumber *userIDNumber; // @synthesize userIDNumber;
