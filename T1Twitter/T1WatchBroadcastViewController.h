...
@class NSString, PTVMergeWatchBroadcastViewController, T1ComposePresenter, T1PeriscopeFollowPromptViewController, T1WatchBroadcastExternalVideoPlayer, T1WatchBroadcastViewControllerModel, T1WatchBroadcastViewControllerPresenter, TFNButton, UIView, UIViewController, UIWindow;
@protocol T1Dockable, T1WatchBroadcastViewControllerDelegate;

@interface T1WatchBroadcastViewController : TFNViewController
{
...
@property(retain, nonatomic) TFNButton *dockButton; // @synthesize dockButton=_dockButton;
