...
@interface T1StandardStatusBirdwatchPivotViewAdapter : TFNComposableViewAdapter
{
}

- (void)birdwatchPivotView:(id)arg1 didTapEntityURL:(id)arg2;
- (void)birdwatchPivotViewDidTapCallToAction:(id)arg1;
- (void)birdwatchPivotViewDidTap:(id)arg1;
