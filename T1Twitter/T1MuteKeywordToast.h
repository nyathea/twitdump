...
@class NSArray, NSString, TFNToastAction, TFNToastScribeContext, TFNTwitterAccount, TFSTwitterMutedKeyword, UIColor, UIImage;

@interface T1MuteKeywordToast : NSObject
{
