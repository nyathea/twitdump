...
@interface UnifiedCardGrokShareDetailsComponentView : TUCLayoutableView
{
    MISSING_TYPE *unifiedCard;
    MISSING_TYPE *component;
    MISSING_TYPE *eventDelegate;
    MISSING_TYPE *imagePipeline;
    MISSING_TYPE *$__lazy_storage_$_grokShareCard;
}

+ (id)sharedLayoutDelegate;
- (void).cxx_destruct;
- (void)didTapAskGrokYourself;
- (void)didTapConversation;
