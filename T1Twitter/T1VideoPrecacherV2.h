...
@class NSMutableArray, NSMutableDictionary, NSString, T1PlayerFactory, TAVWallTime;

@interface T1VideoPrecacherV2 : NSObject
{
    ...
    TAVWallTime *_playerCreationTimestamp;
}

+ (id)sharedInstance;
- (void).cxx_destruct;
@property(retain, nonatomic) TAVWallTime *playerCreationTimestamp; // @synthesize playerCreationTimestamp=_playerCreationTimestamp;
