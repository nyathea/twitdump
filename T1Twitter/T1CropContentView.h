...
@class NSString, T1CropGridView, T1CropGuideView, T1CropShadowView, T1RoundGuideView, T1RoundedSquareGuideView, UIImageView, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
@protocol T1CropContentViewDelegate;

@interface T1CropContentView : UIView
{
    _Bool _dragToCropEnabled;
    struct CGSize _minSize;
    T1CropGuideView *_guideView;
    T1RoundGuideView *_roundView;
    T1RoundedSquareGuideView *_roundedSquareView;
    ...
    double _rotateBase;
    _Bool _rotating;
    double _transformedCropReferenceRatio;
...
@property(nonatomic) double cropReferenceRatio; // @synthesize cropReferenceRatio=_cropReferenceRatio;
...
- (_Bool)_scaleByDelta:(double)arg1;
