...
@interface _TtC14T1TwitterSwift26MediaWebsiteViewController
{
    MISSING_TYPE *contentViewControllerDelegate;
    MISSING_TYPE *pictureInPictureViewController;
    MISSING_TYPE *videoViewModel;
    MISSING_TYPE *pictureInPictureDisplayType;
}
