...
#import <T1Twitter/TFSTweetTextCounterContext-Protocol.h>

@class NSArray, NSLayoutConstraint, NSString, PTVAPIResponseErrorInfo, PTVBroadcast, T1CameraCaptureViewController, T1CameraControlButton, T1CameraEventHashtagsViewController, T1CameraGeoPickerController, T1CameraPlace, T1ComposeAccountAvatarImageView, T1ComposePresenter, TCRAutocompleteController, TCRAutocompleteViewController, TFNCircularCountProgressView, TFNPlaceholderTextView, TFNTwitterComposition, TFSTweetTextCounter, TFSTwitterScribeContext, UIActivityIndicatorView, UIButton, UILabel, UIPanGestureRecognizer, UIScrollView, UITapGestureRecognizer, UIView;

@interface T1CameraCaptureLiveModeViewController : TFNViewController <TFSTweetTextCounterContext>
{
    ...
    T1ComposePresenter *_composeTweetPresenter;
}

- (void).cxx_destruct;
@property(retain, nonatomic) T1ComposePresenter *composeTweetPresenter; // @synthesize composeTweetPresenter=_composeTweetPresenter;
...
@property(retain, nonatomic) TCRAutocompleteViewController *autocompleteViewController; // @synthesize autocompleteViewController=_autocompleteViewController;
...
- (struct CGRect)_t1_main_autocompleteViewFrameForVisibility:(_Bool)arg1;
...
- (double)_t1_main_keyboardHeightInView;
- (void)_t1_notification_keyboardDidChange:(id)arg1;
- (void)_t1_main_adjustViewsWithKeyboard;
