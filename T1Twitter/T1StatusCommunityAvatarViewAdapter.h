...
@interface T1StatusCommunityAvatarViewAdapter : TFNComposableViewAdapter
{
}

- (id)_t1_handleEventWithType:(id)arg1;
- (void)didTapCommunityAvatarView:(id)arg1;
...
- (void)_t1_updateCommunityAvatarView:(id)arg1 forViewModel:(id)arg2;
