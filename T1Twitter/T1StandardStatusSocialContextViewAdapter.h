...
@interface T1StandardStatusSocialContextViewAdapter : TFNComposableViewAdapter
{
    _Bool _isFocal;
...
- (struct CGSize)_t1_actionButtonSizeForText:(id)arg1;
- (struct CGRect)_t1_actionButtonFrameForText:(id)arg1 caretButtonFrame:(struct CGRect)arg2 socialTextFrame:(struct CGRect)arg3;
- (struct CGRect)_t1_midDotFrameForTextFrame:(struct CGRect)arg1;
- (struct CGRect)_t1_leftAlignedActionButtonFrameForText:(id)arg1 midDotFrame:(struct CGRect)arg2;
- (struct CGSize)_t1_maxActionButtonSizeForSocialContextViewModel:(id)arg1;
...
- (void)accessibilityPerformTapActionButton:(id)arg1 viewModel:(id)arg2;
