...
@protocol OS_dispatch_queue, TTMVideoSegmentWriterDelegate;

@interface TTMVideoSegmentWriter : NSObject
{
    ...
    _Bool _useAudio;
    id <TTMVideoSegmentWriterDelegate> _delegate;
    NSURL *_segmentURL;
...
@property(nonatomic) __weak id <TTMVideoSegmentWriterDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_destroy;
