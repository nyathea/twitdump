...
@interface TFNDirectMessageDeviceRegistrationChangeEntry
{
    long long _byUserID;
...
@property(readonly, nonatomic) long long byUserID; // @synthesize byUserID=_byUserID;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
@property(readonly, nonatomic) unsigned long long entryType;
- (id)initWithIdentifier:(id)arg1 time:(id)arg2 byUserID:(long long)arg3 changeType:(long long)arg4;
