...
@class OCFNavigationLink, OCFRichText, OCFSubtaskDataReference;

@interface OCFSelectBannerSubtask
{
    OCFRichText *_primaryText;
    OCFRichText *_secondaryText;
    OCFNavigationLink *_nextLink;
    OCFNavigationLink *_skipLink;
    OCFSubtaskDataReference *_avatarImageSubtaskDataReference;
}
...
+ (id)typeNames;
- (void).cxx_destruct;
@property(readonly, nonatomic) OCFSubtaskDataReference *avatarImageSubtaskDataReference; // @synthesize avatarImageSubtaskDataReference=_avatarImageSubtaskDataReference;
