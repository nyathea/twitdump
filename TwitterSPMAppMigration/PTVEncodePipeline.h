...
@interface PTVEncodePipeline : NSObject
{
    id _weakSelf;
    ...
    struct CGSize _naturalVideoSize;
    _Bool _videoFlipped;
    _Bool _bypassVideoProcessing;
    _Bool _useFrameNaturalSize;
    _Bool _dualEncoder;
    _Bool _recording;
...
- (id)initWithDelegate:(id)arg1 compositedDelegate:(id)arg2 targetSize:(struct CGSize)arg3 dualEncoder:(_Bool)arg4 videoProcessorDisplayView:(id)arg5 audioVisualizerModel:(id)arg6 bypassVideoProcessing:(_Bool)arg7 useFrameNaturalSize:(_Bool)arg8;
