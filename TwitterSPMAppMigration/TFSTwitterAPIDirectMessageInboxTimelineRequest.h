...
- (id)initWithType:(unsigned long long)arg1 maxID:(id)arg2 filterLowQuality:(id)arg3 includeQualityParameter:(id)arg4 filterNSFW:(_Bool)arg5 dmUsers:(_Bool)arg6 supportsEdit:(_Bool)arg7 context:(id)arg8 responseModelBuilder:(id)arg9;
