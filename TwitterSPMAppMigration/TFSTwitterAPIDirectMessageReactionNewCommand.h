...
- (id)request;
- (id)initWithAccountID:(id)arg1 conversationID:(id)arg2 dmID:(id)arg3 reaction:(id)arg4 scribeParams:(id)arg5 requestID:(id)arg6 context:(id)arg7 source:(unsigned long long)arg8 completionBlock:(CDUnknownBlockType)arg9;
