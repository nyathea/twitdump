...
@interface PTVPublishingPipeline : NSObject
{
    id _weakSelf;
...
- (void)videoSource:(id)arg1 willProcessVisualFrame:(struct opaqueCMSampleBuffer *)arg2 captureOrientation:(long long)arg3 completionBlock:(CDUnknownBlockType)arg4;
...
- (void)videoSourceDidUpdateInterruptState:(id)arg1;
...
- (void)setupPipelineForCurrentBitrate:(id)arg1;
...
- (void)dealloc;
- (id)initWithDelegate:(id)arg1 stabilizationEnabled:(_Bool)arg2 saveAsHQEnabled:(_Bool)arg3 customPreviewEnabled:(_Bool)arg4 capture1080pEnabled:(_Bool)arg5 videoSize:(struct CGSize)arg6;
