...
@interface TTMStickerImageSetFetchRequest : NSObject
{
    NSURL *_imageURL;
...
- (id)init;
- (id)initWithURL:(id)arg1 identifier:(id)arg2 targetDimensions:(struct CGSize)arg3 targetContentMode:(long long)arg4;
