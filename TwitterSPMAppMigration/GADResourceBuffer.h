...
@interface GADResourceBuffer : NSObject
{
...
- (void)addObserverForNotifyBytes:(unsigned long long)arg1 toCollection:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;
