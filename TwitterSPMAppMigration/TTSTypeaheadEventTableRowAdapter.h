...
@interface TTSTypeaheadEventTableRowAdapter : TFNItemsDataViewAdapter
{
...
@property(nonatomic) __weak id <TTSTypeaheadEventTableRowAdapterDelegate> delegate; // @synthesize delegate;
