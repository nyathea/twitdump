...
@interface TUCCompactCardAppStoreDetailsComponentView
{
    MISSING_TYPE *iconViewFactoryBlock;
    ...
    MISSING_TYPE *$__lazy_storage_$_ratingsView;
...
- (id)initWithIconViewFactoryBlock:(CDUnknownBlockType)arg1;
