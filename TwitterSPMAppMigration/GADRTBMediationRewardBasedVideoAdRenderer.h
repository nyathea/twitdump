...
@class GADAdRenderingMetadata, GADMediationRewardedAdConfiguration, NSString;
@protocol GADMediationAdapter, GADMediationRewardedAd;

@interface GADRTBMediationRewardBasedVideoAdRenderer
{
...
- (id)adEventDelegateForAdapter:(id)arg1 mediatedAd:(id)arg2;
