...
@interface TFSTwitterAPIMediaSubtitlesDeleteRequest
{
}
...
- (id)initWithMediaID:(id)arg1 mediaCategory:(id)arg2 subtitlesLanguageCode:(id)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
