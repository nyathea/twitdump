...
@interface TFNPagingViewController
{
    _Bool _loopIndexPaths;
    _Bool _pagingEnabled;
    _Bool _bounces;
    _Bool _disableAutomaticReloadOnRotation;
    _Bool _useProgrammaticContentOffsetAnimationEnabled;
...
@property(nonatomic, getter=isUseProgrammaticContentOffsetAnimationEnabled) _Bool useProgrammaticContentOffsetAnimationEnabled; // @synthesize useProgrammaticContentOffsetAnimationEnabled=_useProgrammaticContentOffsetAnimationEnabled;
...
- (void)reloadVisibleViewControllersForceUnload:(_Bool)arg1 withOffsetForIndexPath:(id)arg2;
- (void)reloadVisibleViewControllersForceUnload:(_Bool)arg1;
- (void)reloadVisibleViewControllersWithOffsetForIndexPath:(id)arg1;
...
- (void)reloadViewControllersWithOffsetForIndexPath:(id)arg1;
