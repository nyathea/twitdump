...
- (id <MTLIOFileHandle>)newIOFileHandleWithURL:(NSURL *)arg1 compressionMethod:(long long)arg2 error:(id *)arg3;
- (id <MTLIOFileHandle>)newIOFileHandleWithURL:(NSURL *)arg1 error:(id *)arg2;
