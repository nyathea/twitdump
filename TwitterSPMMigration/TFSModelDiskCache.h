...
+ (void)removeAllCacheFilesSynchronouslyAtDirectoryPath:(id)arg1 errorDestination:(CDUnknownBlockType)arg2;
...
- (void)_tfsmc_prepareRecordEnumerationForKeys:(id)arg1 withSession:(id)arg2 enumerationBlock:(CDUnknownBlockType)arg3;
- (void)enumerateRecordsForKeys:(id)arg1 withSession:(id)arg2 stoppableBlock:(CDUnknownBlockType)arg3;
