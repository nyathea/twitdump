...
@class NSDate, NSString, TFSTwitterStickerImageSet, UIColor;

@interface TFSTwitterSticker : NSObject
{
    NSString *_stickerID;
    ...
    TFSTwitterStickerImageSet *_imageSource;
    double _aspectRatio;
    NSString *_authorID;
...
@property(readonly, nonatomic) TFSTwitterStickerImageSet *imageSource; // @synthesize imageSource=_imageSource;
...
- (id)init;
- (id)initWithStickerID:(id)arg1 stickerType:(unsigned long long)arg2 annotationID:(id)arg3 groupAnnotationID:(id)arg4 stickerSetAnnotationID:(id)arg5 imageSource:(id)arg6 aspectRatio:(double)arg7 authorID:(id)arg8 displayName:(id)arg9 displayDescription:(id)arg10 startTime:(id)arg11 endTime:(id)arg12 variantName:(id)arg13;
