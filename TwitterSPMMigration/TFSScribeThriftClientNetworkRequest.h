...
@interface TFSScribeThriftClientNetworkRequest : NSObject
{
    ...
    _Bool _xCacheIsSet;
    _Bool _contextIsSet;
    _Bool _hasValidGeoLocation;
    _Bool _hasValidGeoLocationIsSet;
    int _httpStatusCode;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool hasValidGeoLocationIsSet; // @synthesize hasValidGeoLocationIsSet=_hasValidGeoLocationIsSet;
@property(nonatomic) _Bool hasValidGeoLocation; // @synthesize hasValidGeoLocation=_hasValidGeoLocation;
