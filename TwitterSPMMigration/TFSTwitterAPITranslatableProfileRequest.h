...
@interface TFSTwitterAPITranslatableProfileRequest
{
}

+ (unsigned long long)baseURLType;
- (id)initWithProfileUserID:(long long)arg1 destinationLanguage:(id)arg2 translationSource:(id)arg3 context:(id)arg4 responseModelBuilder:(id)arg5;
