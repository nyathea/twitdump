...
@interface TIPImageViewFetchHelper : NSObject
{
    ...
    struct {
        ...
        unsigned int didEnterBackground:1;
    } _flags;
    NSString *_loadedImageType;
    UIColor *_debugImageHighlightColor;
    UIColor *_debugInfoTextColor;
    id _didStoreCachedImageNotificationObserver;
    id _debugInfoVisibilityNotificationObserver;
    id _retryFailedLoadsNotificationNotificationObserver;
