...
@interface TFSTwitterImageCategory : NSObject
{
    long long _type;
    NSArray *_variants;
...
+ (CDStruct_a4b508bb)variantSelectionBehavior;
- (void).cxx_destruct;
...
- (id)variantForImageWithOriginalDimensions:(struct CGSize)arg1 targetDimensions:(struct CGSize)arg2 targetContentMode:(long long)arg3 minimumVariantDimensions:(struct CGSize)arg4 maximumVariantDimensions:(struct CGSize)arg5 placeholder:(_Bool)arg6 selectionBehavior:(CDStruct_a4b508bb)arg7;
