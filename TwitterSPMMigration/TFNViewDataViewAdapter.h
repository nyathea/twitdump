...
@interface TFNViewDataViewAdapter
{
    _Bool _useSizeThatFits;
    long long _contentEdgeInsetsMode;
}

@property(nonatomic) long long contentEdgeInsetsMode; // @synthesize contentEdgeInsetsMode=_contentEdgeInsetsMode;
